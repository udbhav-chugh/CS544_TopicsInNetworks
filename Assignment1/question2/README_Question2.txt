...
Here first arguemnt after ./a.out is the case number (1->CaseA, 2->CaseB, 3->CaseC)
...
Note: For CaseC, if you specify only the lambda input, the mu input will be taken such that the blocking probability will be equal to 0.02 (as specified). If both lambda and mu are given, it will be simulated based on given lambda and mu.
